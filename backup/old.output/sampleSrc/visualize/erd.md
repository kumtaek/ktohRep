...
erDiagram
  ...
  n9_table_SAMP ||--|| n4_table_SAMP : "relationship"
  n7_table_SAMP ||--|| n1_table_PUBL : "foreign_key"
  n7_table_SAMP ||--|| n12_table_SAMP : "foreign_key"
```
...
```json
  ...
  table:SAMPLE.PRODUCTS -> table:SAMPLE.CUSTOMERS (relationship)
  table:SAMPLE.ORDERS -> table:PUBLIC.USER_ROLE (foreign_key)
  table:SAMPLE.ORDERS -> table:SAMPLE.USERS (foreign_key)
```

</details>

---
*Source Analyzer v1.1 — 생성 시각: 2025-09-03 15:31:34*